...
df_res = pd.read_csv("csv/stats_manynoise2.csv")
...
ax1.set_ylim(0, 0.6)  # Ensure y-axis limits are set properly
...
ax2.set_ylim(0, 0.6)  # Ensure y-axis limits are set properly
